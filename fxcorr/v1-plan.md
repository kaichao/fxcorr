...
> **冻结文档**——本文记录 V1 阶段的定案与实施，**截止 2026-09-15，此后未再同步**。
> 当前状态见 `v4-plan.md`（版本路线与 V4 结论）、`fxcorr/CLAUDE.md`（工作区现状）；
> 数据接口见 `data-spec.md`，命令行见 `usage.md`。V2/V3 阶段见 `v2-plan.md` / `v3-plan.md`。
